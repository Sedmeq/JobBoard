        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoResumeUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidateProfiles_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Portfolios_CandidateProfiles_CandidateProfileId",
                        column: x => x.CandidateProfileId,
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateProfiles_UserId_Unique",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_UserId_Unique",
                table: "Companies",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_UserId_JobId_Unique",
                table: "JobApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsletterSubscribers_Email_Unique",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Portfolios_CandidateProfileId",
                table: "Portfolios",
                column: "CandidateProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedJobs_UserId_JobId_Unique",
                table: "SavedJobs",
                columns: new[] { "UserId", "JobId" },
                unique: true);
